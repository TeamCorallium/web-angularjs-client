...
app.run(['$rootScope', '$state', '$stateParams', 'localStorageService', 'RestService',
    function ($rootScope, $state, $stateParams, localStorageService, RestService) {
        ...
        $rootScope.app = {
            name: 'Corallium', // name of your project
            author: 'Corallium', // author's name or company name
            description: 'Corallium System', // brief description
            version: '2.0', // current version
            frontEndUrl: 'http://www.corallium.com:8001/Front-End/HTML/index.html',
